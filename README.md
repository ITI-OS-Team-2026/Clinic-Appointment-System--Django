...
![Landing Page](<img width="1911" height="1038" alt="image" src="https://github.com/user-attachments/assets/3cccc3ad-95dc-47ab-83cc-13a6a493cdcd" />)
...
- **Role-Based Access Control:** Secure portals tailored for Patients, Doctors, Receptionists, and Admins.
- **Smart Appointment Booking:** Real-time scheduling with overlap prevention and automatic buffer times.
- **Queue Management:** Real-time patient check-in, tracking, and wait-time management.
- **Medical Records:** Centralized and secure consultations, diagnoses, and prescription management.
- **Analytics & Dashboard:** Executive views on clinic operations, revenue statistics, and user activities.
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/ITI-OS-Team-2026/Clinic-Appointment-System--Django.git
...
**Default Test Accounts created by the seed command:**
(All passwords default to: `Password123!`)
- Admin: `admin@aura.com`
- Doctor: `doctor@aura.com` (or `doctor1@aura.com`, etc.)
- Receptionist: `receptionist@aura.com`
- Patient: `patient@aura.com`

### Running the Server
1. **Start the Tailwind CSS compiler (in a separate terminal):**
   ```bash
...
Detailed visual guide and documentation of all pages and interfaces in the Aura Health system.
